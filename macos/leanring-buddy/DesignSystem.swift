...
enum DS {
    ...
    enum Colors {
        ...
        /// Research mode overlay tint for Clicky so the desktop state change
        /// is immediately visible without relying on panel chrome.
        static let overlayCursorResearchRed = Color(hex: "#FF5A5F")
